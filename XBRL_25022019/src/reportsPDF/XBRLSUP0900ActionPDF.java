...
public class XBRLSUP0900ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP0900ActionPDF.class);
	...
	public String SUP0900PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP0900_Report_" + dtf.format(now) + ".pdf";
