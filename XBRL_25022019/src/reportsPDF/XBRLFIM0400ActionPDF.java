...
public class XBRLFIM0400ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0400ActionPDF.class);
	...
	public String FIM0400PDF() throws IOException, SQLException {
		...
		//java.net.URL main = context.getResource("./JasperResource/FIM0400/FIM0400.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0400_Report_" + dtf.format(now) + ".pdf";
