...
public class XBRLFIM0900ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0900ActionPDF.class);
	...
	public String FIM0900PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0900_Report_" + dtf.format(now) + ".pdf";
