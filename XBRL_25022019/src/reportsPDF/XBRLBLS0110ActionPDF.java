...
public class XBRLBLS0110ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0110ActionPDF.class);
	...
	public String bls0110PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0110_Report_" + dtf.format(now) + ".pdf";
