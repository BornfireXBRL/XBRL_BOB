...
public class XBRLFIM0600ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0600ActionPDF.class);
	...
	public String FIM0600PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0600_Report_" + dtf.format(now) + ".pdf";
