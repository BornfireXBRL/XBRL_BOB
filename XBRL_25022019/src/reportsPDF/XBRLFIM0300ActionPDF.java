...
public class XBRLFIM0300ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0300ActionPDF.class);
	...
	public String FIM0300PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0300_Report_" + dtf.format(now) + ".pdf";
