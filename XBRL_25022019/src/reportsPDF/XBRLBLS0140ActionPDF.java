...
public class XBRLBLS0140ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0140ActionPDF.class);
	...
	public String BLS0140PDF() throws IOException, SQLException {
		...
		//java.net.URL main =context.getRealPath("./JasperResource/BLS0140/BLS0140.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0140_Report_" + dtf.format(now) + ".pdf";
