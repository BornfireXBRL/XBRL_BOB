...
public class XBRLPSC0104ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0104ActionPDF.class);
	...
	public String PSC0104PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0104_Report_" + dtf.format(now) + ".pdf";
