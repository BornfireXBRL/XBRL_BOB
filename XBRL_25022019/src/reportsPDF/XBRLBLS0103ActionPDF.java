...
public class XBRLBLS0103ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0103ActionPDF.class);
	...
	public String BLS0103PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0103_Report_" + dtf.format(now) + ".pdf";
