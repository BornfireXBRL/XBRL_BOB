...
public class XBRLSUP1300ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP1300ActionPDF.class);
	...
	public String SUP1300PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP1300_Report_" + dtf.format(now) + ".pdf";
