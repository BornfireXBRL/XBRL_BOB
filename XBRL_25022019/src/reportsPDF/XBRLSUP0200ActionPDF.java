...
public class XBRLSUP0200ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP0200ActionPDF.class);
	...
	public String SUP0200PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP0200_Report_" + dtf.format(now) + ".pdf";
