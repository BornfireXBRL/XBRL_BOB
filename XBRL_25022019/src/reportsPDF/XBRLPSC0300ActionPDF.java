...
public class XBRLPSC0300ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0300ActionPDF.class);
	...
	public String PSC0300PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0300_Report_" + dtf.format(now) + ".pdf";
