...
public class XBRLBLS0100ActionPDF extends ActionSupport {
	
	static Logger log = Logger.getLogger(XBRLBLS0100ActionPDF.class);
	...
	public String bls0100PDF() throws IOException, SQLException {
	...
	/*	java.net.URL main = context.getResource("./JasperResource/BLS0100/BLS0100_MAIN.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0100_Report_" + dtf.format(now) + ".pdf";
