...
public class XBRLSUP1400ActionPDF extends ActionSupport {
	private static final long serialVersionUID = 1L;
	private InputStream inputStream;
	private String fileName;
	private long contentLength;
	static Logger log = Logger.getLogger(XBRLSUP1400ActionPDF.class);

	@SuppressWarnings({ "unchecked", "deprecation" })
	public String SUP1400PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP1400_Report_" + dtf.format(now) + ".pdf";
