...
public class XBRLBLS0105ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0105ActionPDF.class);
	...
	public String BLS0105PDF() throws IOException, SQLException {
		log.info("====BLS0010EXCEL  Gayu====");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0105_Report_" + dtf.format(now) + ".pdf";
