...
public class XBRLFIM0500ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0500ActionPDF.class);
	...
	public String FIM0500PDF() throws IOException, SQLException {
		log.info("====FIM0500EXCEL Sums Gnana====");
		...
		java.net.URL main = context.getResource("./JasperResource/FIM0500/FIM0500_MAIN.jasper");
		java.net.URL s1 = context.getResource("./JasperResource/FIM0500/FIM0500_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/FIM0500/FIM0500_S2.jasper");
		/*java.net.URL s3 = context.getResource("./JasperResource/FIM0500/FIM0500_S3.jasper");
		java.net.URL s4 = context.getResource("./JasperResource/FIM0500/FIM0500_S4.jasper");*/
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0500_Report_" + dtf.format(now) + ".pdf";
...
*/
			...
			map.put("REPORTING_TIME", request.getParameter("rtime"));
