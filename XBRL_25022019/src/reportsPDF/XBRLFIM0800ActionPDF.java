...
public class XBRLFIM0800ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0800ActionPDF.class);
	...
	public String FIM0800PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0800_Report_" + dtf.format(now) + ".pdf";
