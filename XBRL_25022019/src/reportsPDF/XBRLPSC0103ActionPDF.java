...
public class XBRLPSC0103ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0103ActionPDF.class);
	...
	public String PSC0103PDF() throws IOException, SQLException {
...
*/
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0103_Report_" + dtf.format(now) + ".pdf";
