...
public class XBRLFIM0100ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0100ActionPDF.class);
	...
	public String FIM0100PDF() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/FIM0100/FIM0100_MAIN.jasper");
	java.net.URL s1 = context.getResource("./JasperResource/FIM0100/FIM0100_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/FIM0100/FIM0100_S2.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0100_Report_" + dtf.format(now) + ".pdf";
