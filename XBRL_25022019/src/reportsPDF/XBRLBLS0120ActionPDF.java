...
public class XBRLBLS0120ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0120ActionPDF.class);
	...
	public String bls0120PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0120_Report_" + dtf.format(now) + ".pdf";
