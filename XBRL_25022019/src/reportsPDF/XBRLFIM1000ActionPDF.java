...
public class XBRLFIM1000ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM1000ActionPDF.class);
	...
	public String FIM1000PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM1000_Report_" + dtf.format(now) + ".pdf";
