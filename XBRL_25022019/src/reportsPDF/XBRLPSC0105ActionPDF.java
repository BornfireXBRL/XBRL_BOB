...
public class XBRLPSC0105ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0105ActionPDF.class);
	...
	public String PSC0105PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0105_Report_" + dtf.format(now) + ".pdf";
