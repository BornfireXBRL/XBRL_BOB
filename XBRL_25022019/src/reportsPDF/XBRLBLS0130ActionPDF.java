...
public class XBRLBLS0130ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0130ActionPDF.class);
	...
	public String bls0130PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0130_Report_" + dtf.format(now) + ".pdf";
