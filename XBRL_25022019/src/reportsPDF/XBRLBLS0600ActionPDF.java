...
public class XBRLBLS0600ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0600ActionPDF.class);
	...
	public String BLS0600PDF() throws IOException, SQLException {
		log.info("====BLS0600EXCEL Sums Gnana====");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0600_Report_" + dtf.format(now) + ".pdf";
