...
public class XBRLPSC0102ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0102ActionPDF.class);
	...
	public String PSC0102PDF() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/PSC0102/PSC0102_MAIN.jasper");
	    java.net.URL s1 = context.getResource("./JasperResource/PSC0102/PSC0102_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/PSC0102/PSC0102_S2.jasper");
		//java.net.URL s3 = context.getResource("./JasperResource/PSC0102/PSC0102_S3.jasper");
		//java.net.URL s4 = context.getResource("./JasperResource/PSC0102/BLS0100_S4.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0102_Report_" + dtf.format(now) + ".pdf";
