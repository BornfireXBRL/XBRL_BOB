...
public class XBRLDCG0100ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLDCG0100ActionPDF.class);
	...
	public String DCG0100PDF() throws IOException, SQLException {
...
*/		/*java.net.URL s1 = context.getResource("./JasperResource/BLS0100_S1.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/DCG0100_Report_" + dtf.format(now) + ".pdf";
