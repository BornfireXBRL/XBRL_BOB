...
public class XBRLBLS0106ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0106ActionPDF.class);
	...
	public String BLS0106PDF() throws IOException, SQLException {
		log.info("====BLS00106EXCEL  Gayu====");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0106_Report_" + dtf.format(now) + ".pdf";
