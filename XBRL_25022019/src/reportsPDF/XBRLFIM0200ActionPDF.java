...
public class XBRLFIM0200ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0200ActionPDF.class);
	...
	public String FIM0200PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0200_Report_" + dtf.format(now) + ".pdf";
