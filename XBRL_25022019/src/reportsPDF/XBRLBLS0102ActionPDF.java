...
public class XBRLBLS0102ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0102ActionPDF.class);
	...
	public String BLS0102PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0102_Report_" + dtf.format(now) + ".pdf";
