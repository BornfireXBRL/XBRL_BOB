...
public class XBRLBLS0104ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0104ActionPDF.class);
	...
	public String BLS0104PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0104_Report_" + dtf.format(now) + ".pdf";
