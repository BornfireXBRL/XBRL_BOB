...
public class XBRLSUP0101ActionPDF extends ActionSupport {

static Logger log = Logger.getLogger(XBRLSUP0101ActionPDF.class);
	...
	public String SUP0101PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP0101_Report_" + dtf.format(now) + ".pdf";
