...
public class XBRLPSC0106ActionPDF extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0106ActionPDF.class);
	...
	public String PSC0106PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0106_Report_" + dtf.format(now) + ".pdf";
