...
public class XBRLSUP0100ActionPDF extends ActionSupport {
	
	static Logger log = Logger.getLogger(XBRLSUP0100ActionPDF.class);
	...
	public String SUP0100PDF() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP0100_Report_" + dtf.format(now) + ".pdf";
