...
public class XBRLSUP0600Dao {

	static Logger log = Logger.getLogger(XBRLSUP0600Dao.class);
...
public String Reporef;
	...
	public ArrayList<XBRLSUP0600Dao> ReporefSeq(String dt1, String dt2) {
		...
		ArrayList<XBRLSUP0600Dao> arl = new ArrayList<XBRLSUP0600Dao>();
		...
		try {
			...
			while (rs.next()) {
				...
				XBRLSUP0600Dao xel = new XBRLSUP0600Dao();
...
public ArrayList<XBRLSUP0600Bean> xbrlsup0600s1(String reptype,String instno,String ReporefSeq,String dt2,String dt1,String curr) {
		...
		ArrayList<XBRLSUP0600Bean> arl = new ArrayList<XBRLSUP0600Bean>();
		...
		try {
			...
			while(rs.next()){
				XBRLSUP0600Bean xb=new XBRLSUP0600Bean();
...
public ArrayList<XBRLSUP0600Bean> xbrlsup0600s2(String reptype,String instno,String ReporefSeq,String dt2,String dt1,String curr) {
	...
	try {
			...
			sql.append("select INSTANCE_CODE,REF_CODE_DESC,to_char(TOT_OUTSTANDING,'9,999,999,999,990.99')TOT_OUTSTANDING,to_char(B1_90_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B1_90_TOT_OUTSTANDINGS,to_char(B1_90_IMAPIRED_AMTS,'9,999,999,999,990.99')B1_90_IMAPIRED_AMTS,to_char(B1_90_SPEC_PROVS,'9,999,999,999,990.99')B1_90_SPEC_PROVS,to_char(B91_180_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B91_180_TOT_OUTSTANDINGS,to_char(B91_180_IMAPIRED_AMTS,'9,999,999,999,990.99')B91_180_IMAPIRED_AMTS,to_char(B91_180_SPEC_PROVS,'9,999,999,999,990.99')B91_180_SPEC_PROVS,to_char(B181_360_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B181_360_TOT_OUTSTANDINGS,to_char(B181_360_IMAPIRED_AMTS,'9,999,999,999,990.99')B181_360_IMAPIRED_AMTS,to_char(B181_360_SPEC_PROVS,'9,999,999,999,990.99')B181_360_SPEC_PROVS,to_char(G360_TOT_OUTSTANDINGS,'9,999,999,999,990.99')G360_TOT_OUTSTANDINGS,to_char(G360_IMAPIRED_AMTS,'9,999,999,999,990.99')G360_IMAPIRED_AMTS,to_char(G360_SPEC_PROVS,'9,999,999,999,990.99')G360_SPEC_PROVS,to_char(OTH_TOT_OUTSTANDING,'9,999,999,999,990.99')OTH_TOT_OUTSTANDING,to_char(OTH_IMPAIRED_AMT,'9,999,999,999,990.99')OTH_IMPAIRED_AMT,to_char(OTH_SPEC_PROV,'9,999,999,999,990.99')OTH_SPEC_PROV,to_char(TOT_ARREARS,'9,999,999,999,990.99')TOT_ARREARS,to_char(TOT_IMPAIRED_AMT,'9,999,999,999,990.99')TOT_IMPAIRED_AMT,to_char(TOT_SPEC_PROV,'9,999,999,999,990.99')TOT_SPEC_PROV from table(SUP0600_S2_RPT_FUN('"+reptype+"','"+ReporefSeq+"','"+dt2+"','"+dt2+"','"+dt2+"','"+curr+"'))");
			
	
		log.info("SUP0600S2 "+sql.toString());
...
public ArrayList<XBRLSUP0600Bean> xbrlsup0600s3(String reptype,String instno,String ReporefSeq,String dt2,String dt1,String curr) {
	...
	try {
			...
			sql.append("select INSTANCE_CODE,REF_CODE_DESC,to_char(VALUE,'9,999,999,999,990.99')VALUE from table(SUP0600_S3_RPT_FUN('"+reptype+"','"+ReporefSeq+"','"+dt2+"','"+dt2+"','"+dt2+"','"+curr+"'))");
			
	
		log.info("SUP0600S3 "+sql.toString());
...
public ArrayList<XBRLSUP0600Bean> xbrlsup0600s4(String reptype,String instno,String ReporefSeq,String dt2,String dt1,String curr) {
	...
	try {
			...
			sql.append("select INSTANCE_CODE,REF_CODE_DESC,to_char(TOT_OUTSTANDING,'9,999,999,999,990.99')TOT_OUTSTANDING,to_char(B1_90_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B1_90_TOT_OUTSTANDINGS,to_char(B1_90_IMAPIRED_AMTS,'9,999,999,999,990.99')B1_90_IMAPIRED_AMTS,to_char(B1_90_SPEC_PROVS,'9,999,999,999,990.99')B1_90_SPEC_PROVS,to_char(B91_180_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B91_180_TOT_OUTSTANDINGS,to_char(B91_180_IMAPIRED_AMTS,'9,999,999,999,990.99')B91_180_IMAPIRED_AMTS,to_char(B91_180_SPEC_PROVS,'9,999,999,999,990.99')B91_180_SPEC_PROVS,to_char(B181_360_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B181_360_TOT_OUTSTANDINGS,to_char(B181_360_IMAPIRED_AMTS,'9,999,999,999,990.99')B181_360_IMAPIRED_AMTS,to_char(B181_360_SPEC_PROVS,'9,999,999,999,990.99')B181_360_SPEC_PROVS,to_char(G360_TOT_OUTSTANDINGS,'9,999,999,999,990.99')G360_TOT_OUTSTANDINGS,to_char(G360_IMAPIRED_AMTS,'9,999,999,999,990.99')G360_IMAPIRED_AMTS,to_char(G360_SPEC_PROVS,'9,999,999,999,990.99')G360_SPEC_PROVS,to_char(OTH_TOT_OUTSTANDING,'9,999,999,999,990.99')OTH_TOT_OUTSTANDING,to_char(OTH_IMPAIRED_AMT,'9,999,999,999,990.99')OTH_IMPAIRED_AMT,to_char(OTH_SPEC_PROV,'9,999,999,999,990.99')OTH_SPEC_PROV,to_char(TOT_ARREARS,'9,999,999,999,990.99')TOT_ARREARS,to_char(TOT_IMPAIRED_AMT,'9,999,999,999,990.99')TOT_IMPAIRED_AMT,to_char(TOT_SPEC_PROV,'9,999,999,999,990.99')TOT_SPEC_PROV from table(SUP0600_S4_RPT_FUN('"+reptype+"','"+ReporefSeq+"','"+dt2+"','"+dt2+"','"+dt2+"','"+curr+"'))");
			
	
		log.info("SUP0600S4 "+sql.toString());
...
public ArrayList<XBRLSUP0600Bean> xbrlsup0600details(String reptype,String instno,String ReporefSeq,String dt2,String dt1,String curr) {
...
public ArrayList<XBRLSUP0600Bean> xbrlsup600(String reptype,String dt1,String dt2,String ReporefSeq,String instno,String curr) {
...
public String detailSUP0600saves() {
