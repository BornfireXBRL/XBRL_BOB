...
public class XBRLSUP0606Dao {

	static Logger log = Logger.getLogger(XBRLSUP0606Dao.class);
...
public void setReporef(String reporef) {
	...
	public ArrayList<XBRLSUP0606Dao> ReporefSeq(String dt1, String dt2) {
		...
		ArrayList<XBRLSUP0606Dao> arl = new ArrayList<XBRLSUP0606Dao>();
		...
		try {
			...
			while (rs.next()) {
				...
				XBRLSUP0606Dao xel = new XBRLSUP0606Dao();
...
public ArrayList<XBRLSUP0606Bean> xbrl1fimsums1(String reptype,String ReporefSeq, String instno,String dt2,String dt1,String curr) {
		...
		ArrayList<XBRLSUP0606Bean> arl = new ArrayList<XBRLSUP0606Bean>();
		...
		try {
			...
			sql.append("select INSTANCE_DESC,INSTANCE_CODE,to_char(TOT_OUTSTANDING,'9,999,999,999,990.99')TOT_OUTSTANDING,to_char(B1_90_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B1_90_TOT_OUTSTANDINGS,to_char(B1_90_IMAPIRED_AMTS,'9,999,999,999,990.99')B1_90_IMAPIRED_AMTS,to_char(B1_90_SPEC_PROVS,'9,999,999,999,990.99')B1_90_SPEC_PROVS,to_char(B91_180_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B91_180_TOT_OUTSTANDINGS,to_char(B91_180_IMAPIRED_AMTS,'9,999,999,999,990.99')B91_180_IMAPIRED_AMTS,to_char(B91_180_SPEC_PROVS,'9,999,999,999,990.99')B91_180_SPEC_PROVS,to_char(B181_360_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B181_360_TOT_OUTSTANDINGS,to_char(B181_360_IMAPIRED_AMTS,'9,999,999,999,990.99')B181_360_IMAPIRED_AMTS,to_char(B181_360_SPEC_PROVS,'9,999,999,999,990.99')B181_360_SPEC_PROVS,to_char(G360_TOT_OUTSTANDINGS,'9,999,999,999,990.99')G360_TOT_OUTSTANDINGS,to_char(G360_IMAPIRED_AMTS,'9,999,999,999,990.99')G360_IMAPIRED_AMTS,to_char(G360_SPEC_PROVS,'9,999,999,999,990.99')G360_SPEC_PROVS,to_char(OTH_TOT_OUTSTANDING,'9,999,999,999,990.99')OTH_TOT_OUTSTANDING,to_char(OTH_IMPAIRED_AMT,'9,999,999,999,990.99')OTH_IMPAIRED_AMT,to_char(OTH_SPEC_PROV,'9,999,999,999,990.99')OTH_SPEC_PROV,to_char(TOT_ARREARS,'9,999,999,999,990.99')TOT_ARREARS,to_char(TOT_IMPAIRED_AMT,'9,999,999,999,990.99')TOT_IMPAIRED_AMT,to_char(TOT_SPEC_PROV,'9,999,999,999,990.99')TOT_SPEC_PROV from table(SUP0606_S1_RPT_FUN('"+reptype+"','"+ReporefSeq+"','"+dt2+"','"+dt2+"','"+dt2+"','"+curr+"'))");
			
	
		log.info("SUP0606S1 "+sql.toString());
		...
		while(rs.next()){
			XBRLSUP0606Bean xb=new XBRLSUP0606Bean();
			
			
				xb.setRefCode(NullCheck.isNotNull(rs.getString("INSTANCE_DESC")));
...
public ArrayList<XBRLSUP0606Bean> xbrlSUP0606sum2(String reptype,String ReporefSeq,String  instno,String dt2,String dt1,String curr) {
	...
	try {
		...
		sql.append("select DYNAMIC_DOMAIN,SL_NO,COUNTRY,ISIC_CODE,NATURE_OF_CUST,to_char(TOT_OUTSTANDING,'9,999,999,999,990.99')TOT_OUTSTANDING,to_char(B1_90_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B1_90_TOT_OUTSTANDINGS,to_char(B1_90_IMAPIRED_AMTS,'9,999,999,999,990.99')B1_90_IMAPIRED_AMTS,to_char(B1_90_SPEC_PROVS,'9,999,999,999,990.99')B1_90_SPEC_PROVS,to_char(B91_180_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B91_180_TOT_OUTSTANDINGS,to_char(B91_180_IMAPIRED_AMTS,'9,999,999,999,990.99')B91_180_IMAPIRED_AMTS,to_char(B91_180_SPEC_PROVS,'9,999,999,999,990.99')B91_180_SPEC_PROVS,to_char(B181_360_TOT_OUTSTANDINGS,'9,999,999,999,990.99')B181_360_TOT_OUTSTANDINGS,to_char(B181_360_IMAPIRED_AMTS,'9,999,999,999,990.99')B181_360_IMAPIRED_AMTS,to_char(B181_360_SPEC_PROVS,'9,999,999,999,990.99')B181_360_SPEC_PROVS,to_char(G360_TOT_OUTSTANDINGS,'9,999,999,999,990.99')G360_TOT_OUTSTANDINGS,to_char(G360_IMAPIRED_AMTS,'9,999,999,999,990.99')G360_IMAPIRED_AMTS,to_char(G360_SPEC_PROVS,'9,999,999,999,990.99')G360_SPEC_PROVS,to_char(OTH_TOT_OUTSTANDING,'9,999,999,999,990.99')OTH_TOT_OUTSTANDING,to_char(OTH_IMPAIRED_AMT,'9,999,999,999,990.99')OTH_IMPAIRED_AMT,to_char(OTH_SPEC_PROV,'9,999,999,999,990.99')OTH_SPEC_PROV,to_char(TOT_ARREARS,'9,999,999,999,990.99')TOT_ARREARS,to_char(TOT_IMPAIRED_AMT,'9,999,999,999,990.99')TOT_IMPAIRED_AMT,to_char(TOT_SPEC_PROV,'9,999,999,999,990.99')TOT_SPEC_PROV from table(SUP0606_S2_RPT_FUN('"+reptype+"','"+ReporefSeq+"','"+dt2+"','"+dt2+"','"+dt2+"','"+curr+"'))");
		

	log.info("SUP0606S2 "+sql.toString());
	...
	while(rs.next()){
		XBRLSUP0606Bean xb=new XBRLSUP0606Bean();
			...
			xb.setDydomain(NullCheck.isNotNull(rs.getString("DYNAMIC_DOMAIN")));
...
public ArrayList<XBRLSUP0606Bean> xbrlSUP0606sum3(String reptype,String ReporefSeq,String  instno,String dt2,String dt1,String curr) {
	...
	try {
		...
		sql.append("select INSTANCE_CODE,REF_CODE_DESC,to_char(VALUE,'9,999,999,999,990.99')VALUE from table(SUP0606_S3_RPT_FUN('"+reptype+"','"+ReporefSeq+"','"+dt2+"','"+dt2+"','"+dt2+"','"+curr+"'))");
	...
	while(rs.next()){
		...
		xb.setInstanceCode2(NullCheck.isNotNull(rs.getString("INSTANCE_CODE")));
		xb.setRefdecod(NullCheck.isNotNull(rs.getString("REF_CODE_DESC")));
...
public ArrayList<XBRLSUP0606Bean> xbrlSUP0606details(String reptype,String ReporefSeq,String instno,String dt2,String dt1,String curr) {
...
public ArrayList<XBRLSUP0606Bean> xbrlsup602(String reptype,String dt1,String dt2,String ReporefSeq,String instno,String curr) {
	...
	sql.append("select ACCT_NUMBER,ACCT_NAME,CUST_ID,SCHM_CODE,SCHM_TYPE,TO_CHAR(ACCT_OPN_DATE,'DD-MM-YYYY')ACCT_OPN_DATE,to_char(INT_RATE,'9,999,999,999,990.99')INT_RATE,to_char(ACCT_BALANCE_AMT_AC,'9,999,999,999,990.99')ACCT_BALANCE_AMT_AC,ACCT_CRNCY_CODE,ISIC_CODE,NATURE_OF_CUST,NRE_FLG,COUNTRY,BOM_GROUP_IDENTIFIER,CUST_UNIQUE_IDENTIFIER,to_char(LOAN_AMOUNT,'9,999,999,999,990.99')LOAN_AMOUNT,to_char(SPEC_PROV,'9,999,999,999,990.99')SPEC_PROV,to_char(BAD_DR_WR_OFF,'9,999,999,999,990.99')BAD_DR_WR_OFF,DPD_CNTR,IMPAIRED_FLG,to_char(SEC_AMOUNT,'9,999,999,999,990.99')SEC_AMOUNT,PURPOSE_OF_LOAN,SME_FLG,NON_FUND_BASED_FACILITIES,TO_CHAR(RESHDL_DATE,'DD-MM-YYYY')RESHDL_DATE,RESTRUCTURED_FLG,NO_OF_RESTRUCTURE,TO_CHAR(REPORT_DATE,'DD-MM-YYYY')REPORT_DATE from table(SUP0606_DTL_FUN('"+reptype+"','"+instno+"','"+ReporefSeq+"','"+dt2+"','"+dt2+"','"+dt2+"','MUR'))");
...
public String detailSUP0606saves() {
...
public String SUP0606chckmodified() {
...
public String modSUP0606cancel() {
	String status = "";
	HttpServletRequest request = ServletActionContext.getRequest();
	ConnectionManager connMgr = new ConnectionManager();
	Connection conn = connMgr.getConnection();
...
public ArrayList<XBRLSUP0606Bean> SUP0606verify() {
...
public String SUP0606verifymaster() {
	String status = "";
	HttpServletRequest request = ServletActionContext.getRequest();
	ConnectionManager connMgr = new ConnectionManager();
	Connection conn = connMgr.getConnection();
	...
	if (xb.getModtyp().equals("A")) {
		...
		sql.append(
				"INSERT INTO SUP0010_MAST_TABLE(ACCT_NUMBER,ACCT_NAME,CUST_ID,SCHM_CODE,SCHM_TYPE,ACCT_OPN_DATE,INT_RATE,"
						...
						+ df.formatdate(request.getParameter("schdate")) + "','" + request.getParameter("resflg")
		...
		sql.append("update  SUP0010_MOD_TABLE set ACCT_NUMBER ='"
				...
				+ df.formatdate(request.getParameter("schdate")) + "',RESTRUCTURED_FLG ='"
