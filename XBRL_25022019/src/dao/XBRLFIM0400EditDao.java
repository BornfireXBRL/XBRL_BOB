...
public class XBRLFIM0400EditDao {
	
	static Logger log = Logger.getLogger(XBRLFIM0400EditDao.class);
...
public ArrayList<XBRLFIM0400EditDao> ReporefSeq(){
	...
	ArrayList<XBRLFIM0400EditDao> arl = new ArrayList<XBRLFIM0400EditDao>();
	sql.append("select REPORT_REF_NO from FIM0400_MOD_TABLE GROUP BY REPORT_REF_NO ORDER BY REPORT_REF_NO");
	...
	try {
		...
		while(rs.next()){
			...
			XBRLFIM0400EditDao xel=new XBRLFIM0400EditDao();
