...
public class XBRLSUP0602Dao {

	static Logger log = Logger.getLogger(XBRLSUP0602Dao.class);
...
public void setReporef(String reporef) {
	...
	public ArrayList<XBRLSUP0602Dao> ReporefSeq(String dt1, String dt2) {
		...
		ArrayList<XBRLSUP0602Dao> arl = new ArrayList<XBRLSUP0602Dao>();
		...
		try {
			...
			while (rs.next()) {
				...
				XBRLSUP0602Dao xel = new XBRLSUP0602Dao();
...
public ArrayList<XBRLSUP0602Bean> xbrl1fimsums1(String reptype,String instno,String ReporefSeq,String dt2,String dt1,String curr) {
		...
		ArrayList<XBRLSUP0602Bean> arl = new ArrayList<XBRLSUP0602Bean>();
		...
		while(rs.next()){
			XBRLSUP0602Bean xb=new XBRLSUP0602Bean();
...
public ArrayList<XBRLSUP0602Bean> xbrlsup0602sum2(String reptype,String ReporefSeq,String  instno,String dt2,String dt1,String curr) {
	...
	try {
		...
		sql.append("select INSTANCE_CODE,REF_CODE_DESC,to_char(VALUE,'9,999,999,999,990.99')VALUE from table(SUP0602_S2_RPT_FUN('"+reptype+"','"+ReporefSeq+"','"+dt2+"','"+dt2+"','"+dt2+"','MUR'))");
		

	log.info("SUP0602S2 "+sql.toString());
...
public ArrayList<XBRLSUP0602Bean> xbrlsup0602details(String reptype,String ReporefSeq,String instno,String dt2,String dt1,String curr) {
...
public ArrayList<XBRLSUP0602Bean> xbrlsup602(String reptype,String dt1,String dt2,String ReporefSeq,String instno,String curr) {
...
public String detailSUP0602saves() {
