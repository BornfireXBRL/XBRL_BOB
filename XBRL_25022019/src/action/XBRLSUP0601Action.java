...
public class XBRLSUP0601Action {
	static Logger log = Logger.getLogger(XBRLSUP0601Action.class);
	public String sec1SUP0601;
	public String sec2SUP0601;
	public String sec3SUP0601;
	public String detSUP0601  ;
	
	public String getDetSUP0601() {
		return detSUP0601;
	}

	public void setDetSUP0601(String detSUP0601) {
		this.detSUP0601 = detSUP0601;
	}

	public String getSec3SUP0601() {
		return sec3SUP0601;
	}

	public void setSec3SUP0601(String sec3sup0601) {
		sec3SUP0601 = sec3sup0601;
	}

	public String getSec2SUP0601() {
		return sec2SUP0601;
	}

	public void setSec2SUP0601(String sec2sup0601) {
		sec2SUP0601 = sec2sup0601;
	}

	public String getSec1SUP0601() {
		return sec1SUP0601;
	}

	public void setSec1SUP0601(String sec1sup0601) {
		sec1SUP0601 = sec1sup0601;
	}
	...
	public String modXbSUPCreate601() throws SQLException {
		...
		// HttpSession session = request.getSession();
		log.info("insert Action modXbCreateSUP0601");
	...
	public String section1SUP0601() {

		HttpServletRequest request = ServletActionContext.getRequest();
		DateFormat df = new DateFormat();
		log.info("inside sup0601 action");
		
		XBRLSUP0601Dao bsd = new XBRLSUP0601Dao();

		ArrayList<XBRLSUP0601Bean> arl = bsd.xbrlsup0601s1(request.getParameter("repname"),request.getParameter("instno"),
		...
		Gson gson = new Gson();
		sec1SUP0601 = gson.toJson(arl);

		return "success";

	}

	public String section2SUP0601() {
		...
		ArrayList<XBRLSUP0601Bean> arl = bsd.xbrlsup0601s2(request.getParameter("repname"),request.getParameter("instno"),
				request.getParameter("ReporefSeq"),
				df.formatdate(request.getParameter("dt2")), df.formatdate(request.getParameter("dt1")),request.getParameter("curr"));
		...
		Gson gson = new Gson();
		sec2SUP0601 = gson.toJson(arl);

		return "success";

	}
	
	public String section3SUP0601() {
		...
		ArrayList<XBRLSUP0601Bean> arl = bsd.xbrlsup0601s3(request.getParameter("repname"),request.getParameter("instno"),
				request.getParameter("ReporefSeq"),
				df.formatdate(request.getParameter("dt2")), df.formatdate(request.getParameter("dt1")),request.getParameter("curr"));
...
public String detailsSUP0601() {
		...
		ArrayList<XBRLSUP0601Bean> arl = bsd.xbrlsup0601details(request.getParameter("repname"),request.getParameter("instno"),
				request.getParameter("ReporefSeq"),
				df.formatdate(request.getParameter("dt2")), df.formatdate(request.getParameter("dt1")),request.getParameter("curr"));
