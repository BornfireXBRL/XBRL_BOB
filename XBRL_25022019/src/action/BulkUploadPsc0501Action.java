...
public class BulkUploadPsc0501Action 
{
	...
	public String psc501Upload() throws SQLException, IOException 
	{
		...
		{
			sql1.append("TRUNCATE  TABLE PSC0501_MANUAL_TABLE");
					          ...
					          .open(is)) 
			{
				...
				int i1=0;
					  for (Sheet s : workbook)
					  {
						...
						if (i1 > 0) {
							...
							String query = "Insert into PSC0501_MANUAL_TABLE(APPLICATION_NO,APPLICANT_NAME,RECEIVED_DATE,REJECTION_REASON,REPORT_DATE,DEL_FLG,RCRE_USER_ID,RCRE_TIME) values(?,?,?,?,?,?,?,?)";
							...
							stmt.setString(8,df.formatdate(Format.format(date)));
	            ...
	            System.out.println("inside the catch");
					...
					if (rs > 0) 
					{
						...
						pstmt.setString(1, "PSC0501_MANUAL");
						...
						status = "success";
						request.setAttribute("Page", "bulkuploadpsc501");
	...
	public String psc105Upload1() throws SQLException, IOException 
	{
		...
		for (int i = 0; i < fileUpload.length; i++) 
		{
			...
			try {
			PreparedStatement pstmt1 =conn.prepareStatement("Insert into PSC0501_MANUAL_TABLE(APPLICATION_NO,APPLICANT_NAME,RECEIVED_DATE,REJECTION_REASON,REPORT_DATE,DEL_FLG,RCRE_USER_ID,RCRE_TIME) values(?,?,?,?,?,?,?,?)");
            ...
            while((nextLine = reader.readNext()) != null) 
            {
                ...
                pstmt1.setString(7,session.getAttribute("userName").toString());
                pstmt1.setString(8,df.formatdate(Format.format(date)));
