...
public class BulkUploadPym0100Action extends ActionSupport 
{
	...
	public String pym0100Upload() throws SQLException, IOException 
	{
					  ...
					  for (Sheet s : workbook)
					  {
					    ...
					    for (Row r : s) 
					    {
							...
							if (i1 > 0) {
								...
								log.info(dataHolder);
								String query = "Insert into PYM0100_MANUAL_TABLE(MODES,CHQ_NUMBER,ACCT_NUMBER,ACCT_NAME,TRAN_DATE,VALUE_DATE,CHQ_AMOUNT,CRNCY,DEL_FLG,RCRE_USER_ID,RCRE_TIME,REPORT_DATE) values(?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public String pym0100Upload1() throws SQLException, IOException 
	{
		...
		for (int i = 0; i < fileUpload.length; i++) 
		{
			...
			try {
			PreparedStatement pstmt1 =conn.prepareStatement("Insert into PYM0100_MANUAL_TABLE(MODES,CHQ_NUMBER,ACCT_NUMBER,ACCT_NAME,TRAN_DATE,VALUE_DATE,CHQ_AMOUNT,CRNCY,DEL_FLG,RCRE_USER_ID,RCRE_TIME,REPORT_DATE) values(?,?,?,?,?,?,?,?,?,?,?,?)");
