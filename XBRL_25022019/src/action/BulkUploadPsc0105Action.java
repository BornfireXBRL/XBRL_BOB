...
public class BulkUploadPsc0105Action 
{
	...
	public String psc105Upload() throws SQLException, IOException 
	{
		...
		if (Integer.parseInt(request.getParameter("cnt")) > 0) 
		{
			...
			sql1.append("TRUNCATE  TABLE PSC0105_S2_MANUAL_TABLE");
					          ...
					          .open(is)) 
			{
					  ...
					  for (Sheet s : workbook)
					  {
					    ...
					    for (Row r : s) 
					    {
							...
							if (i1 > 0) {
								...
								String query = "Insert into PSC0105_S2_MANUAL_TABLE(APPLICATION_NO,ENTITY_NAME,ENTITY_TYPE,FACILITY_TYPE,FACILITY_AMT,REJ_REASON,APP_RECEIVED_DT,APP_REJ_DT,REPORT_DATE,DEL_FLG,RCRE_USER_ID,RCRE_TIME) values(?,?,?,?,?,?,?,?,?,?,?,?)";
								System.out.println(query.toString());
								
								stmt = conn.prepareStatement(query);
								System.out.println(dataHolder.get(8));
	            ...
	            System.out.println("inside the catch");
					...
					if (rs > 0) 
					{
						...
						pstmt.setString(1, "PSC0105_MANUAL");
						...
						status = "success";
						request.setAttribute("Page", "bulkuploadpsc105");
	...
	public String psc105Upload1() throws SQLException, IOException 
	{
		...
		for (int i = 0; i < fileUpload.length; i++) 
		{
			...
			try {
			PreparedStatement pstmt1 =conn.prepareStatement("Insert into PSC0105_S2_MANUAL_TABLE(APPLICATION_NO,ENTITY_NAME,ENTITY_TYPE,FACILITY_TYPE,FACILITY_AMT,REJ_REASON,APP_RECEIVED_DT,APP_REJ_DT,REPORT_DATE,DEL_FLG,RCRE_USER_ID,RCRE_TIME) values(?,?,?,?,?,?,?,?,?,?,?,?)");
