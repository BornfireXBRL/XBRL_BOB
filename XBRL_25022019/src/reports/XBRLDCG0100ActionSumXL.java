...
public class XBRLDCG0100ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLDCG0100ActionSumXL.class);
	...
	public String DCG0100EXCELsums() throws IOException, SQLException {
		...
		//java.net.URL main = context.getResource("./JasperResource/DCG0100/DCG0100.jasper");
		...
		String main_report = context.getRealPath("./JasperResource/DCG0100/DCG0100.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/DCG0100_Report_" + dtf.format(now) + ".xlsx";
