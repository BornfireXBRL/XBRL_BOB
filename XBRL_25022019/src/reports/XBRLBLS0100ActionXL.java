...
public class XBRLBLS0100ActionXL extends ActionSupport {
	...
	public String bls0100EXCEL() throws IOException, SQLException {
		...
		String main_report = context.getRealPath("./JasperResource/BLS0100/DTL_JASPER/BLS0100_ALL_DTL.jasper");
		String subReport1 = context.getRealPath("./JasperResource/BLS0100/DTL_JASPER/BLS0100_S1_DTL.jasper");
		String subReport2 = context.getRealPath("./JasperResource/BLS0100/DTL_JASPER/BLS0100_S2_DTL.jasper");
		String subReport3 = context.getRealPath("./JasperResource/BLS0100/DTL_JASPER/BLS0100_S3_DTL.jasper");
		String subReport4 = context.getRealPath("./JasperResource/BLS0100/DTL_JASPER/BLS0100_S4_DTL.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0100_Report_" + dtf.format(now) + ".xlsx";
