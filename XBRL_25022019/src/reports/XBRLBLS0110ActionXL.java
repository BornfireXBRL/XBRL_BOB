...
public class XBRLBLS0110ActionXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0100ActionXL.class);
	...
	public String bls0110EXCEL() throws IOException, SQLException {
		log.info("====BLS0100EXCEL Sums Gnana====");
		...
		/*java.net.URL main = context.getResource("./JasperResource/BLS0100/BLS0100_MAIN.jasper");
		java.net.URL s1 = context.getResource("./JasperResource/BLS0100/BLS0100_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/BLS0100/BLS0100_S2.jasper");
		java.net.URL s3 = context.getResource("./JasperResource/BLS0100/BLS0100_S3.jasper");
		java.net.URL s4 = context.getResource("./JasperResource/BLS0100/BLS0100_S4.jasper");*/
		String main_report = context.getRealPath("./JasperResource/BLS0110/DTL_JASPER/BLS0110_ALL_DTL.jasper");
		String subReport1 = context.getRealPath("./JasperResource/BLS0110/DTL_JASPER/BLS0110_S1_DTL.jasper");
		String subReport2 = context.getRealPath("./JasperResource/BLS0110/DTL_JASPER/BLS0110_S2_DTL.jasper");
		/*String subReport3 = context.getRealPath("./JasperResource/BLS0110/DTL_JASPER/BLS0100_S3_DTL.jasper");
		String subReport4 = context.getRealPath("./JasperResource/BLS0110/DTL_JASPER/BLS0100_S4_DTL.jasper");*/
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0110_Report_" + dtf.format(now) + ".xlsx";
