...
public class XBRLSUP1300ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP1300ActionSumXL.class);
	...
	public String SUP1300EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/SUP1300/SUP1300.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP1300_Report_" + dtf.format(now) + ".xlsx";
