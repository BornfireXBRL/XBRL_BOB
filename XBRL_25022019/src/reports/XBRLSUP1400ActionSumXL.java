...
public class XBRLSUP1400ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP1400ActionSumXL.class);
	...
	public String SUP1400EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/SUP1400/SUP1400.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP1400_Report_" + dtf.format(now) + ".xlsx";
