...
public class XBRLSUP0900ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP0900ActionSumXL.class);
	...
	public String SUP0900EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/SUP0900/SUP0900.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP0900_Report_" + dtf.format(now) + ".xlsx";
