...
public class XBRLBLS0106ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0106ActionSumXL.class);
	...
	public String BLS0106EXCELsums() throws IOException, SQLException {
		log.info("====BLS00106EXCEL Sums Gayu====");
		...
		/*java.net.URL main = context.getResource("./JasperResource/BLS0106/BLS0106.jasper");*/
		...
		String main_report = context.getRealPath("./JasperResource/BLS0106/BLS0106.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0106_Report_" + dtf.format(now) + ".xlsx";
