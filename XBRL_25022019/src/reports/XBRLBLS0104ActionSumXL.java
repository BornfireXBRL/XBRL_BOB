...
public class XBRLBLS0104ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0104ActionSumXL.class);
	...
	public String BLS0104EXCELsums() throws IOException, SQLException {
		...
		//java.net.URL main = context.getResource("./JasperResource/BLS0104/BLS0104.jasper");
		...
		String main_report = context.getRealPath("./JasperResource/BLS0104/BLS0104.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0104_Report_" + dtf.format(now) + ".xlsx";
