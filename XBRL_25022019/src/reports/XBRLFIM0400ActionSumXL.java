...
public class XBRLFIM0400ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0400ActionSumXL.class);
	...
	public String FIM0400EXCELsums() throws IOException, SQLException {
		...
		//java.net.URL main = context.getRealPath("./JasperResource/FIM0400/FIM0400.jasper");
		...
		String main_report = context.getRealPath("./JasperResource/FIM0400/FIM0400.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0400_Report_" + dtf.format(now) + ".xlsx";
