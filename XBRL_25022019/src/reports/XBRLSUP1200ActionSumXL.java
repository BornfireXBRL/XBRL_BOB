...
public class XBRLSUP1200ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP1200ActionSumXL.class);
	...
	public String SUP1200EXCELsums() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP1200_Report_" + dtf.format(now) + ".xlsx";
