...
public class XBRLCRR0100ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLCRR0100ActionSumXL.class);
	...
	public String CRR0100EXCELSums() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/CRR0100_Report_" + dtf.format(now) + ".xlsx";
