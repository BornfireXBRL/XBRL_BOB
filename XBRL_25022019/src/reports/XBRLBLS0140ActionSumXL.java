...
public class XBRLBLS0140ActionSumXL extends ActionSupport {
	...
	public String BLS0140EXCELsums() throws IOException, SQLException {
		...
		String main_report = context.getRealPath("./JasperResource/BLS0140/BLS0140.jasper");
