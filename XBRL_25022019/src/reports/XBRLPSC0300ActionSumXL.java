...
public class XBRLPSC0300ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0300ActionSumXL.class);
	...
	public String PSC0300EXCELsums() throws IOException, SQLException {
		log.info("====PSC0300EXCEL Sums Gnana====");
		...
		java.net.URL main = context.getResource("./JasperResource/PSC0300/PSC0300_MAIN.jasper");
		java.net.URL s1 = context.getResource("./JasperResource/PSC0300/PSC0300_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/PSC0300/PSC0300_S2.jasper");
		/*java.net.URL s3 = context.getResource("./JasperResource/PSC0300/PSC0300_S3.jasper");
		java.net.URL s4 = context.getResource("./JasperResource/PSC0300/PSC0300_S4.jasper");*/
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0300_Report_" + dtf.format(now) + ".xlsx";
