...
public class XBRLPSC0105ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0105ActionSumXL.class);
	...
	public String PSC0105EXCELSums() throws IOException, SQLException {
		log.info("====PSC0105EXCEL Sums Gnana====");
		...
		java.net.URL main = context.getResource("./JasperResource/PSC0105/PSC0105_MAIN.jasper");
		java.net.URL s1 = context.getResource("./JasperResource/PSC0105/PSC0105_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/PSC0105/PSC0105_S2.jasper");
		java.net.URL s3 = context.getResource("./JasperResource/PSC0105/PSC0105_S3.jasper");
		java.net.URL s4 = context.getResource("./JasperResource/PSC0105/PSC0105_S4.jasper");
		java.net.URL s5 = context.getResource("./JasperResource/PSC0105/PSC0105_S5.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0105_Report_" + dtf.format(now) + ".xlsx";
			...
			File subrep5 = new File(subReport5);
			...
			map.put("SUB_REPORT_DIR5", subrep5);
