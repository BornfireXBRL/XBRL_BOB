...
public class XBRLBLS0100ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0100ActionSumXL.class);
	...
	public String bls0100EXCELSums() throws IOException, SQLException {
		...
		String main_report = context.getRealPath("./JasperResource/BLS0100/BLS0100_MAIN.jasper");
		String subReport1 = context.getRealPath("./JasperResource/BLS0100/BLS0100_S1.jasper");
		String subReport2 = context.getRealPath("./JasperResource/BLS0100/BLS0100_S2.jasper");
		String subReport3 = context.getRealPath("./JasperResource/BLS0100/BLS0100_S3.jasper");
		String subReport4 = context.getRealPath("./JasperResource/BLS0100/BLS0100_S4.jasper");
