...
public class XBRLFIM0200ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0200ActionSumXL.class);
	...
	public String FIM0200EXCELsums() throws IOException, SQLException {
		...
		//java.net.URL main = context.getResource("./JasperResource/FIM0200/FIM0200.jasper");
		...
		String main_report = context.getRealPath("./JasperResource/FIM0200/FIM0200.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0200_Report_" + dtf.format(now) + ".xlsx";
