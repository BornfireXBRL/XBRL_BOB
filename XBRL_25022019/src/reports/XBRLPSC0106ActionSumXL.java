...
public class XBRLPSC0106ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0106ActionSumXL.class);
	...
	public String PSC0106EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/PSC0106/PSC0106.jasper");
	   /* java.net.URL s1 = context.getResource("./JasperResource/PSC0106/PSC0106_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/PSC0106/PSC0106_S2.jasper");
...
*/
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0106_Report_" + dtf.format(now) + ".xlsx";
