...
public class XBRLFIM0500ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0500ActionSumXL.class);
	...
	public String FIM0500EXCELsums() throws IOException, SQLException {
	...
	String subReport1 = s1.getFile();
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0500_Report_" + dtf.format(now) + ".xlsx";
