...
public class XBRLBLS0600ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0600ActionSumXL.class);
	...
	public String BLS0600EXCELsums() throws IOException, SQLException {
		log.info("====BLS0600EXCEL Sums Gayu====");
		...
		//java.net.URL main = context.getResource("./JasperResource/BLS0600/BLS0600.jasper");
		...
		String main_report = context.getRealPath("./JasperResource/BLS0600/BLS0600.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0600_Report_" + dtf.format(now) + ".xlsx";
