...
public class XBRLPSC0103ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0103ActionSumXL.class);
	...
	public String PSC0103EXCELsums() throws IOException, SQLException {
		log.info("====PSC0103EXCEL Sums Gnana====");
		...
		//java.net.URL main = context.getResource("./JasperResource/PSC0103/PSC0103_MAIN.jasper");
		//java.net.URL s1 = context.getResource("./JasperResource/PSC0103/PSC0103_S1.jasper");
		//java.net.URL s2 = context.getResource("./JasperResource/PSC0103/PSC0103_S2.jasper");
		/*java.net.URL s3 = context.getResource("./JasperResource/PSC0103/PSC0103_S3.jasper");
		java.net.URL s4 = context.getResource("./JasperResource/PSC0103/PSC0103_S4.jasper");*/
		String main_report = context.getRealPath("./JasperResource/PSC0103/PSC0103_MAIN.jasper");
		String subReport1 = context.getRealPath("./JasperResource/PSC0103/PSC0103_S1.jasper");
		String subReport2 = context.getRealPath("./JasperResource/PSC0103/PSC0103_S2.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0103_Report_" + dtf.format(now) + ".xlsx";
