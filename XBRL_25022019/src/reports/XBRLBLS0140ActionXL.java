...
public class XBRLBLS0140ActionXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0140ActionSumXL.class);
	...
	public String BLS0140EXCEL() throws IOException, SQLException {
		...
		//java.net.URL main = context.getResource("./JasperResource/BLS0140/BLS0140.jasper");
		/*java.net.URL s1 = context.getResource("./JasperResource/BLS0100_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/BLS0100_S2.jasper");
		java.net.URL s3 = context.getResource("./JasperResource/BLS0100_S3.jasper");
		java.net.URL s4 = context.getResource("./JasperResource/BLS0100_S4.jasper");*/
		String main_report = context.getRealPath("./JasperResource/BLS0140/DTL_JASPER/BLS0140_DTL_MAIN.jasper");
		String subReport1 = context.getRealPath("./JasperResource/BLS0140/DTL_JASPER/BLS0140_S1_DTL_FUN.jasper");
		String  subReport2 = context.getRealPath("./JasperResource/BLS0140/DTL_JASPER/BLS0140_S2_DTL_FUN.jasper");
...
*/
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0140_Report_" + dtf.format(now) + ".xlsx";
