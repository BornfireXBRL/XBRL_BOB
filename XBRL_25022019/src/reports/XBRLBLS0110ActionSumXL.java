...
public class XBRLBLS0110ActionSumXL extends ActionSupport {
	
	static Logger log = Logger.getLogger(XBRLBLS0110ActionSumXL.class);
	...
	public String bls0110EXCELSums() throws IOException, SQLException {
		...
		/*java.net.URL main = context.getResource("./JasperResource/BLS0110/BLS0110.jasper");*/
		...
		String main_report = context.getRealPath("./JasperResource/BLS0110/BLS0110.jasper");
