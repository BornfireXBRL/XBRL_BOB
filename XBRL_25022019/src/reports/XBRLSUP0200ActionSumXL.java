...
public class XBRLSUP0200ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP0200ActionSumXL.class);
	...
	public String SUP0200EXCELsums() throws IOException, SQLException {
		log.info("====SUP0200EXCEL Sums Gnana====");
		...
		java.net.URL main = context.getResource("./JasperResource/SUP0200/SUP0200_MAIN.jasper");
		java.net.URL s1 = context.getResource("./JasperResource/SUP0200/SUP0200_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/SUP0200/SUP0200_S2.jasper");
		/*java.net.URL s3 = context.getResource("./JasperResource/SUP0200/SUP0200_S3.jasper");
		java.net.URL s4 = context.getResource("./JasperResource/SUP0200/SUP0200_S4.jasper");*/
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP0200_Report_" + dtf.format(now) + ".xlsx";
