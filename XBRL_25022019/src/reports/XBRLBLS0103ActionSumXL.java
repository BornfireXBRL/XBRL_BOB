...
public class XBRLBLS0103ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0103ActionSumXL.class);
	...
	public String BLS0103EXCELsums() throws IOException, SQLException {
		...
		/*java.net.URL main = context.getResource("./JasperResource/BLS0103/BLS0103.jasper");*/
		...
		String main_report = context.getRealPath("./JasperResource/BLS0103/BLS0103.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0103_Report_" + dtf.format(now) + ".xlsx";
