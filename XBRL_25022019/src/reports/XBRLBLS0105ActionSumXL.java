...
public class XBRLBLS0105ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0105ActionSumXL.class);
	...
	public String BLS0105EXCELsums() throws IOException, SQLException {
		log.info("====BLS0010EXCEL Sums Gayu====");
		...
		/*java.net.URL main = context.getResource("./JasperResource/BLS0105/BLS0105.jasper");*/
		...
		String main_report = context.getRealPath("./JasperResource/BLS0105/BLS0105.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0105_Report_" + dtf.format(now) + ".xlsx";
