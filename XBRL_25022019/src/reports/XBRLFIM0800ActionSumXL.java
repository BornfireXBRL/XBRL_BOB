...
public class XBRLFIM0800ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0800ActionSumXL.class);
	...
	public String FIM0800EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/FIM0800/FIM0800.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0800_Report_" + dtf.format(now) + ".xlsx";
