...
public class XBRLBLS0120ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0120ActionSumXL.class);
	...
	public String bls0120EXCELSums() throws IOException, SQLException {
		...
		//java.net.URL main = context.getResource("./JasperResource/BLS0120/BLS0120.jasper");
		...
		String main_report = context.getRealPath("./JasperResource/BLS0120/BLS0120.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0120_Report_" + dtf.format(now) + ".xlsx";
