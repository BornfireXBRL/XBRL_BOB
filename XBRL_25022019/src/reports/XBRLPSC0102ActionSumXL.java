...
public class XBRLPSC0102ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLPSC0102ActionSumXL.class);
	...
	public String PSC0102EXCELsums() throws IOException, SQLException {
		...
		try {
			...
			String filePath = getText("downloadpath") + "/PSC0102_Report_" + dtf.format(now) + ".xlsx";
