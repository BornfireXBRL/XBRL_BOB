...
public class XBRLBLS0130ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0130ActionSumXL.class);
	...
	public String bls0130EXCELSums() throws IOException, SQLException {
		...
		//java.net.URL main = context.getResource("./JasperResource/BLS0130/BLS0130.jasper");
		...
		String main_report = context.getRealPath("./JasperResource/BLS0130/BLS0130.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0130_Report_" + dtf.format(now) + ".xlsx";
