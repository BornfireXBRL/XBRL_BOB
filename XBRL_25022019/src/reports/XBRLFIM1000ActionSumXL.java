...
public class XBRLFIM1000ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM1000ActionSumXL.class);
	...
	public String FIM1000EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/FIM1000/FIM1000.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM1000_Report_" + dtf.format(now) + ".xlsx";
