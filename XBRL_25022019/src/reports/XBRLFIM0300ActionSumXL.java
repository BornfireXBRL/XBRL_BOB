...
public class XBRLFIM0300ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0300ActionSumXL.class);
	...
	public String FIM0300EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/FIM0300/FIM0300.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0300_Report_" + dtf.format(now) + ".xlsx";
