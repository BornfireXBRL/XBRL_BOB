...
public class XBRLSUP0101ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP0101ActionSumXL.class);
	...
	public String SUP0101EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/SUP0101/SUP0101.jasper");
		...
		XBRLReportMasterBean xrm = rm.xbrlsummarypdf("SUP0100");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP0101_Report_" + dtf.format(now) + ".xlsx";
