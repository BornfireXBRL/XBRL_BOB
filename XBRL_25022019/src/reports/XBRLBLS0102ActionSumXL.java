...
public class XBRLBLS0102ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLBLS0102ActionSumXL.class);
	...
	public String BLS0102EXCELsums() throws IOException, SQLException {
		log.info("====BLS0100EXCEL Sums Gayu====");
		...
		//java.net.URL main = context.getResource("./JasperResource/BLS0102/BLS0102.jasper");
		...
		String main_report = context.getRealPath("./JasperResource/BLS0102/BLS0102.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/BLS0102_Report_" + dtf.format(now) + ".xlsx";
