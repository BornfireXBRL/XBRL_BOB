...
public class XBRLFIM0100ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0100ActionSumXL.class);
	...
	public String FIM0100EXCELsums() throws IOException, SQLException {
		log.info("====FIM0100EXCEL Sums Gayu====");
		...
		/*java.net.URL s3 = context.getResource("./JasperResource/FIM0100/FIM0100_S3.jasper");
		java.net.URL s4 = context.getResource("./JasperResource/FIM0100/FIM0100_S4.jasper");*/
		String main_report = context.getRealPath("./JasperResource/FIM0100/FIM0100_MAIN.jasper");
		String subReport1 =  context.getRealPath("./JasperResource/FIM0100/FIM0100_S1.jasper");
		String subReport2 =  context.getRealPath("./JasperResource/FIM0100/FIM0100_S2.jasper");
...
*/
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0100_Report_" + dtf.format(now) + ".xlsx";
