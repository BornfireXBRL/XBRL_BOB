...
public class XBRLSUP0100ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLSUP0100ActionSumXL.class);
	...
	public String SUP0100EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/SUP0100/SUP0100.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/SUP0100_Report_" + dtf.format(now) + ".xlsx";
