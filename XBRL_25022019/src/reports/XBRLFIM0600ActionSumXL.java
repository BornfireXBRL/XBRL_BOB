...
public class XBRLFIM0600ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0600ActionSumXL.class);
	...
	public String FIM0600EXCELSums() throws IOException, SQLException {
		log.info("====FIM0600EXCEL Sums Gnana====");
		...
		java.net.URL main = context.getResource("./JasperResource/FIM0600/FIM0600_MAIN.jasper");
		java.net.URL s1 = context.getResource("./JasperResource/FIM0600/FIM0600_S1.jasper");
		java.net.URL s2 = context.getResource("./JasperResource/FIM0600/FIM0600_S2.jasper");
		java.net.URL s3 = context.getResource("./JasperResource/FIM0600/FIM0600_S3.jasper");
		/*java.net.URL s4 = context.getResource("./JasperResource/FIM0600/FIM0600_S4.jasper");*/
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0600_Report_" + dtf.format(now) + ".xlsx";
