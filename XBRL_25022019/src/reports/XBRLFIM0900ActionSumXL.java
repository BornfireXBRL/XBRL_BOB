...
public class XBRLFIM0900ActionSumXL extends ActionSupport {
	static Logger log = Logger.getLogger(XBRLFIM0900ActionSumXL.class);
	...
	public String FIM0900EXCELsums() throws IOException, SQLException {
		...
		java.net.URL main = context.getResource("./JasperResource/FIM0900/FIM0900.jasper");
		...
		try {
			...
			String filePath = getText("downloadpath") + "/FIM0900_Report_" + dtf.format(now) + ".xlsx";
