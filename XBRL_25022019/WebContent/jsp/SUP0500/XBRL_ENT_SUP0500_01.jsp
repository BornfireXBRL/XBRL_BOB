...
<%@page
	import="dao.XBRLSUP0500Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLSUP0500Dao xrl = new XBRLSUP0500Dao();
ArrayList<XBRLSUP0500Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLSUP0500Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLSUP0500Dao xrl1=itlist.next();
