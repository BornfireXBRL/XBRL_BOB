...
<meta charset="utf-8">
<meta http-equiv="refresh" content="<%=session.getMaxInactiveInterval() %>;url=XBRLSession.jsp?uName=<%=session.getAttribute("username")%>" /><meta http-equiv="X-UA-Compatible" content="IE=edge">
		  ...
		  if($("#function1").val()=="Select"){
			...
			$("#fun").show().fadeOut(2000);
		       $("#fun").html("Select function Name");
				 ...
				 location.href = "XBRL_VER_FIM0400_01.jsp?reptype="+$("#reportType").val(); 
					 ...
					 success : function(res) {						 
						 ...
						 if(res.fim0400 == 0){
							 ...
							 return false;
								...
								//alert("ELSE"); 
								location.href = "XBRL_REP_FIM0400_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&reptype="+$("#reportType").val()+"&typo="+"sum"+"&curr="+$("#rptCurrency").val();
		...
		$("#etid").show().fadeOut(2000);
	       $("#etid").html("Enter Report Ref No");
					...
					//alert("From Date" + $("#dt1").val());
						location.href = "XBRL_REP_FIM0400_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&ReporefSeq="+$("#ReporefSeq").val()+"&reptype="+$("#reportType").val()+"&typo="+"sum"+"&curr="+$("#rptCurrency").val();

					//location.href = "XBRL_REP_FIM0400_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#K").val()+"&reptype="+$("#reportType").val()+"&typo="+"sum"+"&curr="+$("#rptCurrency").val();
					  }   
...
function fnentity(){
	...
	if($("#dt3").val()==""){
		...
		myWindow6 = window.open("XBRL_ENT_FIM0400_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val(),"50",
		...
		$("#divLoading").addClass('show'); 
		 $(".container1").modal('toggle'); 
			...
			if(ext=="csv"){
				 ...
				 CriteriaForm.action="drcsvuploadFilefim400.action?method=fim0400Upload1"+"&dt2="+$("#dt2").val()+"&cnt="+$("#count").val();
					CriteriaForm.submit();
			 }else{
				 
				 CriteriaForm.action="druploadFilefim400.action?method=fim0400Upload"+"&dt2="+$("#dt2").val()+"&cnt="+$("#count").val();
					CriteriaForm.submit();
			 }
...
<div class="loader"></div>
	<form class="form-horizontal" method="post" name="CriteriaForm" id="cform"
		...
		<div class="panel-heading " 
			...
			<font size="2"><b> FIM 0400 XBRL Report : <b id="sub"
					Style="display: none"></b></b> Statement of Swap transactions -Daily </font>
 ...
 -->		
				...
				<div class="form-group ">
						<div class="row col-sm-12 ">
							...
							<div class="col-sm-3 ">
								<input type="text" name="reportType" id="reportType" value="FIM0400"
									class="form-control" />
							...
							<div class="col-sm-3">
								<input type="text" name="dt3" id="dt3"
									value="" class="form-control" placeholder="dd-mm-yyyy" />
<span style="color: red; font-size: 10px; display: none;" id="dt33" class="error">Select as on date</span>
 ...
 -->
				...
				<div class="container1" >
						...
						<div class="panel-heading" style="padding-left: 84px;"><font size="3"><b>FIM0400 - Upload</b></font>
...
<!-- <script type="text/javascript" src="XBRL_CRT_FIM0400_01.js"></script> -->
