...
<%@page
	import="dao.XBRLFIM0400Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLFIM0400Dao xrl = new XBRLFIM0400Dao();
ArrayList<XBRLFIM0400Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLFIM0400Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLFIM0400Dao xrl1=itlist.next();
