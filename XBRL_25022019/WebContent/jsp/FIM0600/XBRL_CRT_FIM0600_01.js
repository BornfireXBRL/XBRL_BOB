    ...
    $("#todt").html("Enter To Date");
						...
						//alert("eeeeeeeeeeeeeeeeeeeee");
						 ...
						 if(res.kasama == 0){
							 ...
							 return false;
								...
								//alert("ELSE"); 
								location.href = "XBRL_REP_FIM0600_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val();
		...
		$("#etid").show().fadeOut(2000);
	       $("#etid").html("Enter Report Ref No");
					...
					location.href = "XBRL_REP_FIM0600_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&ReporefSeq="+$("#ReporefSeq").val();
					  }   
...
function fnentity(){
	...
	myWindow6 = window.open("XBRL_ENT_FIM0600_01.jsp","50",
