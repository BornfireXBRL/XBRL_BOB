...
<%@page
	import="dao.XBRLPYM0100Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLPYM0100Dao xrl = new XBRLPYM0100Dao();
ArrayList<XBRLPYM0100Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLPYM0100Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLPYM0100Dao xrl1=itlist.next();
