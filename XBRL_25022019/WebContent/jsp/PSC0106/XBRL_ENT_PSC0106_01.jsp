...
<%@page
	import="dao.XBRLPSC0106Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLPSC0106Dao xrl = new XBRLPSC0106Dao();
ArrayList<XBRLPSC0106Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLPSC0106Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLPSC0106Dao xrl1=itlist.next();
