...
<%@page
	import="dao.XBRLPSC0103Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLPSC0103Dao xrl = new XBRLPSC0103Dao();
ArrayList<XBRLPSC0103Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLPSC0103Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLPSC0103Dao xrl1=itlist.next();
