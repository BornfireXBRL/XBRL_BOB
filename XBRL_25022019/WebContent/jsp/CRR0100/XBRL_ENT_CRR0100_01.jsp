...
<%@page
	import="dao.XBRLCRR0100Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLCRR0100Dao xrl = new XBRLCRR0100Dao();
ArrayList<XBRLCRR0100Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLCRR0100Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLCRR0100Dao xrl1=itlist.next();
