...
<%@page
	import="dao.XBRLSUP1500Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLSUP1500Dao xrl = new XBRLSUP1500Dao();
ArrayList<XBRLSUP1500Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLSUP1500Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLSUP1500Dao xrl1=itlist.next();
