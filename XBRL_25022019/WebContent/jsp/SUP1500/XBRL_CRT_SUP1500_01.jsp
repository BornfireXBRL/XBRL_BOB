		...
		$("#divLoading").addClass('show'); 
		 $(".container1").modal('toggle'); 
			...
			if(ext=="csv"){
				 ...
				 CriteriaForm.action="drcsvuploadFilesup1500.action?method=sup1500Upload1"+"&dt2="+$("#dt2").val()+"&cnt="+$("#count").val();
					CriteriaForm.submit();
			 }else{
				 
				 CriteriaForm.action="druploadFilesup1500.action?method=sup1500Upload1"+"&dt2="+$("#dt2").val()+"&cnt="+$("#count").val();
					CriteriaForm.submit();
			 }
    ...
    $("#todt").html("Enter To Date");
						...
						//alert("eeeeeeeeeeeeeeeeeeeee");
						 ...
						 if(res.sup1500 == 0){
							 ...
							 return false;
								...
								alert("ELSE"); 
								location.href = "XBRL_REP_SUP1500_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&reptype="+$("#reportType").val()+"&typo="+"sum"+"&curr="+$("#rptCurrency").val();
		...
		$("#etid").show().fadeOut(2000);
	       $("#etid").html("Enter Report Ref No");
					...
					location.href = "XBRL_REP_SUP1500_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&ReporefSeq="+$("#ReporefSeq").val()+"&reptype="+$("#reportType").val()+"&curr="+$("#rptCurrency").val();
					  }   
...
function fnentity(){
	...
	if($("#dt3").val()==""){
		...
		myWindow6 = window.open("XBRL_ENT_SUP1500_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val(),"50",
...
<div class="loader"></div>
	<form class="form-horizontal" method="post" name="CriteriaForm" id="cform"
		...
		<div class="panel-heading text-center tl" 
			...
			<font size="2"><b> SUP 1500 XBRL Report : <b id="sub"
					Style="display: none"></b></b>Assessment of Domestic - Systemically Important Banks </font>
    ...
    margin-left: 60px;">
				...
				<div class="form-group ">
						<div class="row col-sm-12 ">
							...
							<div class="col-sm-3 ">
								<input type="text" name="reportType" id="reportType" value="SUP1500"
									class="form-control" />
...
<span style="color: red; font-size: 10px; display: none;" id="dt33" class="error">Select as on date</span>
 ...
 -->
				...
				<div class="container1" >
						...
						<div class="panel-heading" style="padding-left: 84px;"><font size="3"><b>SUP1500 - Upload</b></font>
...
<!-- <script type="text/javascript" src="XBRL_CRT_SUP1500_01.js"></script> -->
