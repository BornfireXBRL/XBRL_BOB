...
<%@page
	import="dao.XBRLBLS0700Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLBLS0700Dao xrl = new XBRLBLS0700Dao();
ArrayList<XBRLBLS0700Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLBLS0700Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLBLS0700Dao xrl1=itlist.next();
