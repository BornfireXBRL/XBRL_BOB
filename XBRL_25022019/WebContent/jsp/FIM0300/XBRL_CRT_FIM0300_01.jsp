...
$(document).ready(function(){
	...
	/* ajax to check count in FIM0300_Mod_table to display verify option or not */
	var det={
			"type":"chkuser"
		};
		  ...
		  if($("#function1").val()=="Select"){
			...
			$("#fun").show().fadeOut(2000);
		       $("#fun").html("Select function Name");
				 ...
				 location.href = "XBRL_VER_FIM0300_01.jsp?reptype="+$("#reportType").val(); 
...
*/								
								location.href = "XBRL_REP_FIM0300_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&reptype="+$("#reportType").val()+"&curr="+$("#rptCurrency").val();
							}  
...
*/					  
					...
					location.href = "XBRL_REP_FIM0300_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&ReporefSeq="+$("#ReporefSeq").val()+"&reptype="+$("#reportType").val()+"&curr="+$("#rptCurrency").val();
		...
		$("#divLoading").addClass('show'); 
		 $(".container1").modal('toggle'); 
			...
			if(ext=="csv"){
				 ...
				 CriteriaForm.action="drcsvuploadFilefim300.action?method=fim0300Upload1"+"&dt2="+$("#dt2").val()+"&cnt="+$("#count").val();
					CriteriaForm.submit();
			 }else{
				 
				 CriteriaForm.action="druploadFilefim300.action?method=fim0300Upload"+"&dt2="+$("#dt2").val()+"&cnt="+$("#count").val();
					CriteriaForm.submit();
			 }
...
<div class="loader"></div>
	<form class="form-horizontal" method="post" name="CriteriaForm" id="cform"
		...
		<div class="panel-heading " 
			...
			<font size="2"><b> FIM 0300 XBRL Report : <b id="sub"
					Style="display: none"></b></b> Indicative Exchange Rates </font>
		...
		<!-- <div class="container-fluid" >
			...
			<div class="panel-body"> -->
								<div  class="container-fluid gmd-1 hover " style="padding-top: 23px; width: 85%;margin-left: 60px;">
		 ...
		 -->
				...
				<div class="form-group ">
						<div class="row col-sm-12 ">
							...
							<div class="col-sm-3 ">
								<input type="text" name="reportType" id="reportType" value="FIM0300"
									class="form-control" />
 ...
 -->
					...
					<div class="container1" >
						...
						<div class="panel-heading" style="padding-left: 84px;"><font size="3"><b>FIM0300- Upload</b></font>
...
<script type="text/javascript" src="XBRL_CRT_FIM0300_01.js"></script>
