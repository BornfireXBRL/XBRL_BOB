...
<%@page
	import="dao.XBRLBOP0202Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLBOP0202Dao xrl = new XBRLBOP0202Dao();
ArrayList<XBRLBOP0202Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLBOP0202Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLBOP0202Dao xrl1=itlist.next();
