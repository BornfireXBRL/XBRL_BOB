...
<%@page
	import="dao.XBRLBLS0106Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLBLS0106Dao xrl = new XBRLBLS0106Dao();
ArrayList<XBRLBLS0106Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLBLS0106Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLBLS0106Dao xrl1=itlist.next();
