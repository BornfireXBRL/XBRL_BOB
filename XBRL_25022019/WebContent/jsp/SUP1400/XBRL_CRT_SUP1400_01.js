						...
						//alert("eeeeeeeeeeeeeeeeeeeee");
						 ...
						 if(res.sup14 == 0){
							 ...
							 return false;
								...
								location.href = "XBRL_REP_SUP1400_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val();
...
if($("#function1").val()=="EditEntity"){
		...
		$("#etid").show().fadeOut(2000);
	       $("#etid").html("Enter Report Ref No");
					...
					location.href = "XBRL_REP_SUP1400_01.jsp?ReporefSeq="+$("#ReporefSeq").val();
					  }   
	...
	$( "#btnGo").click(function() {
					 ...
					 success : function(res) {						 
						 ...
						 if(res.sup14 == 0){
							 ...
							 return false;
								...
								location.href = "XBRL_REP_SUP1400_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&reptype="+$("#reportType").val()+"&curr="+$("#rptCurrency").val();
		...
		$("#etid").show().fadeOut(2000);
	       $("#etid").html("Enter Report Ref No");
					...
					location.href = "XBRL_REP_SUP1400_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&ReporefSeq="+$("#ReporefSeq").val()+"&reptype="+$("#reportType").val()+"&curr="+$("#rptCurrency").val();
					  }   
...
function fnentity(){
	...
	myWindow6 = window.open("XBRL_ENT_SUP1400_01.jsp","50",
