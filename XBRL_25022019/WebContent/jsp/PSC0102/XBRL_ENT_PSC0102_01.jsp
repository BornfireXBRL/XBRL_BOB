...
<%@page
	import="dao.XBRLPSC0102Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLPSC0102Dao xrl = new XBRLPSC0102Dao();
ArrayList<XBRLPSC0102Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
			...
			<div class="panel panel-primary filterable">
				...
				<table class="table">
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLPSC0102Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLPSC0102Dao xrl1=itlist.next();
