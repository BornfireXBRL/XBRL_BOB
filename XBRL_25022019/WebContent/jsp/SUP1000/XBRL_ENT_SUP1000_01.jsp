...
<%@page
	import="dao.XBRLSUP1000Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLSUP1000Dao xrl = new XBRLSUP1000Dao();
ArrayList<XBRLSUP1000Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLSUP1000Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLSUP1000Dao xrl1=itlist.next();
