						...
						//alert("eeeeeeeeeeeeeeeeeeeee");
						 ...
						 if(res.kasama == 0){
							 ...
							 return false;
								...
								alert("ELSE"); 
							 location.href = "XBRL_REP_FIM0500_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&reptype="+$("#reportType").val()+"&typo="+"sum"+"&curr="+$("#rptCurrency").val();
...
function fnentity(){
	...
	myWindow6 = window.open("XBRL_ENT_FIM0500_01.jsp","50",
