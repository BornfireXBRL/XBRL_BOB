...
<%@page
	import="dao.XBRLFIM0500Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLFIM0500Dao xrl = new XBRLFIM0500Dao();
ArrayList<XBRLFIM0500Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLFIM0500Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLFIM0500Dao xrl1=itlist.next();
