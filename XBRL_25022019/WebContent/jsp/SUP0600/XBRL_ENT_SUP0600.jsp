...
<%@page
	import="dao.XBRLSUP0600Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLSUP0600Dao xrl = new XBRLSUP0600Dao();
ArrayList<XBRLSUP0600Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLSUP0600Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLSUP0600Dao xrl1=itlist.next();
