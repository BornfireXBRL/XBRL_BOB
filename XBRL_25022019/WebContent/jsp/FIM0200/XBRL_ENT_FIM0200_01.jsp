...
<%@page
	import="dao.XBRLFIM0200Dao ,java.util.ArrayList,java.util.Iterator"%>


<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%

XBRLFIM0200Dao xrl = new XBRLFIM0200Dao();
ArrayList<XBRLFIM0200Dao> list=xrl.ReporefSeq(request.getParameter("dt1"),request.getParameter("dt2"));
		...
		<div class="row">
            ...
            <col width="100"> -->
					...
					<tbody>
						<%
                int i = 1;
              Iterator<XBRLFIM0200Dao> itlist=list.iterator();
								while(itlist.hasNext()){
									XBRLFIM0200Dao xrl1=itlist.next();
