		...
		$("#divLoading").addClass('show'); 
		 $(".container1").modal('toggle'); 
			...
			if(ext=="csv"){
				 ...
				 CriteriaForm.action="drcsvuploadFilefim200.action?method=bls0103Upload1"+"&dt2="+$("#dt2").val()+"&cnt="+$("#count").val();
					CriteriaForm.submit();
			 }else{
				 
				 CriteriaForm.action="druploadFilefim200.action?method=bls0103Upload"+"&dt2="+$("#dt2").val()+"&cnt="+$("#count").val();
					CriteriaForm.submit();
			 }
    ...
    $("#todt").html("Enter To Date");
						...
						//alert("eeeeeeeeeeeeeeeeeeeee");
						 ...
						 if(res.code == 0){
							 ...
							 return false;
								...
								//alert("ELSE"); 
								location.href = "XBRL_REP_FIM0200_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&reptype="+$("#reportType").val()+"&typo="+"sum"+"&curr="+$("#rptCurrency").val();
		...
		$("#etid").show().fadeOut(2000);
	       $("#etid").html("Enter Report Ref No");
					...
					location.href = "XBRL_REP_FIM0200_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val()+"&ReporefSeq="+$("#ReporefSeq").val()+"&reptype="+$("#reportType").val()+"&typo="+"sum"+"&curr="+$("#rptCurrency").val();
					  }   
	 ...
	 */
		 ...
		 $("#function1").change(function(){
		   ...
		   $("#rptCurrency,#ReporefSeq").attr("disabled", true);
			   ...
			   $("#ReporefSeq, #dt3,#ReporefSeq").attr("disabled", false);
		   }
		  });
...
function fnentity(){
	...
	if($("#dt3").val()==""){
		...
		myWindow6 = window.open("XBRL_ENT_FIM0200_01.jsp?dt1="+$("#dt1").val()+"&dt2="+$("#dt2").val(),"50",
...
<div class="loader"></div>
	<form class="form-horizontal" method="post" name="CriteriaForm" id="cform"
		...
		<div class="panel-heading text-center" 
			...
			<font size="2"><b> FIM 0200  XBRL Report : <b id="sub"
					Style="display: none"></b></b> Statement of Interbank Foreign Exchange Market </font>
    ...
    margin-left: 60px;">
				...
				<div class="form-group ">
						<div class="row col-sm-12 ">
							...
							<div class="col-sm-3 ">
								<input type="text" name="reportType" id="reportType" value="FIM0200"
									class="form-control" />
...
<span style="color: red; font-size: 10px; display: none;" id="asondt" class="error">Select as on date</span>
 ...
 -->
				...
				<div class="container1" >
						...
						<div class="panel-heading" style="padding-left: 84px;"><font size="3"><b>FIM0200 - Upload</b></font>
...
<!--  <script type="text/javascript" src="XBRL_CRT_FIM0200_01.js"></script>  -->
